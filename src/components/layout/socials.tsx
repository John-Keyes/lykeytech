...
const Socials = () => (
                        <SubTitle id="socials" aria-label="Socials" sectionclassname="flex flex-column flex-center space-below" text="Contact">
                            <Button id="socials-message-button" aria-label="Socials Message Button" className="bg-purple bg-hover-light-purple button-glow-purple">
                                <Link id="socials-message-button-link" aria-label="Socials Message Button Link" href="mailto:john.keyes@lykeytech.com">Send Message</Link>
                            </Button>
                            ...
                            <div id="socials-links-container" aria-label="Socials Links Container" className="flex flex-row">
                                <Link id="socials-link-0" aria-label="Socials Links 0" href="https://www.linkedin.com/in/john-keyes-ba4a7820b/" target="_blank" rel="noopener noreferrer">
                                    <span id="socials-link-icon-0" aria-label="Socials Links Icon 0" className="fa-brands fa-linkedin fa-2xl text-hover-clear-blue"/>
                                </Link>
                                <Link id="socials-link-1" aria-label="Socials Links 1" className="space-infront" href="https://github.com/John-Keyes" target="_blank" rel="noopener noreferrer">
                                ...
                                <Link id="socials-link-2" aria-label="Socials Link 2" className="space-infront" href="https://www.upwork.com/freelancers/~018106e7e0817e9ad0" target="_blank" rel="noopener noreferrer">
                                    <span id="socials-link-icon-2" aria-label="Socials Links Icon 2" className="fa-brands fa-upwork fa-2xl text-hover-clear-blue"/>
                                </Link>
                                <Link id="socials-link-3" aria-label="Socials Link 3" className="space-infront" href="https://www.instagram.com/lykeytech" target="_blank" rel="noopener noreferrer">
                                ...
                                <Link id="socials-link-4" aria-label="Socials Link 4" className="space-infront" href="https://www.facebook.com/profile.php?id=61575014991131" target="_blank" rel="noopener noreferrer">
                                    <span id="socials-link-icon-4" aria-label="Socials Links Icon 4" className="fa-brands fa-facebook fa-2xl text-hover-clear-blue"/>
                                </Link>
                                <Link id="socials-link-5" aria-label="Socials Link 5" className="space-infront" href="https://www.youtube.com/@LyKeyTech" target="_blank" rel="noopener noreferrer">
                                ...
                                <Link id="socials-link-6" aria-label="Socials Link 6" className="space-infront" href="https://www.tiktok.com/@lykeytech" target="_blank" rel="noopener noreferrer">
