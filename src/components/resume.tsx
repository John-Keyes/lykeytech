                ...
                <div className="resume-side-bar-section">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><p className="resume-p">Call: <Link href="tel:+14073983915" className="" target="_blank" rel="noopener noreferrer">+1 407-398-3915</Link></p></li>
                            <li><p className="resume-p">Email: <Link href="mailto:john.keyes@lykeytech.com" className="" target="_blank" rel="noopener noreferrer">john.keyes@lykeytech.com</Link></p></li>
                        </ul>
                    </div>
                </div>
                <div className="resume-side-bar-section">
                    ...
                    <div>
                        <ul>
                        <li><p className="resume-p"><Link href="https://www.lykeytech.com" className="" target="_blank" rel="noopener noreferrer">Website</Link></p></li>
                            <li><p className="resume-p"><Link href="https://github.com/John-Keyes" className="" target="_blank" rel="noopener noreferrer">Github</Link></p></li>
                            <li><p className="resume-p"><Link href="https://www.linkedin.com/in/john-keyes-ba4a7820b/" className="" target="_blank" rel="noopener noreferrer">LinkedIn</Link></p></li>
                            <li><p className="resume-p"><Link href="https://cmscritic.com/" className="" target="_blank" rel="noopener noreferrer">Work example in a team</Link></p></li>
                        </ul>
                    </div>
                </div>
                <div className="resume-side-bar-section">
                    ...
                    <div className="resume-body-section-body">
                        <div className="resume-body-section-body-item">
                            <div className="resume-body-section-body-item-title-container">
                                <h3><Link href="https://outlier.ai/" className="" target="_blank" rel="noopener noreferrer">Outlier.ai</Link></h3>
                        ...
                        <div className="resume-body-section-body-item">
                            <div className="resume-body-section-body-item-title-container">
                                <h3><Link href="https://www.solodev.com/" className="" target="_blank" rel="noopener noreferrer">Solodev</Link></h3>
                                <p className="resume-p">Address: 800 N Magnolia Ave #1400, Orlando, FL 32803</p>
                                <p className="resume-p"><Link href="tel:+18008597656" target="_blank" rel="noopener noreferrer" className="">800-859-7656</Link></p>
                            </div>
                            <div className="resume-body-section-body-item-body-container">
                                <div>
                        ...
                        <div className="resume-body-section-body-item">
                            <div className="resume-body-section-body-item-title-container">
                                <h3><Link href="https://mylearningtools.org/" className="" target="_blank" rel="noopener noreferrer">Resilience</Link></h3>
                                <p className="resume-p">4103 USF Cedar Cir, 202 Tampa, FL 33620</p>
                                <p className="resume-p"><Link className="" href="tel:+18138107943" target="_blank" rel="noopener noreferrer">813-810-7943</Link></p>
                            </div>
